	         ...
	         <tr>
	            ...
	            <?php if (!empty($resultSet)) {  foreach($resultSet as $res) {?>
	        		<tr>
		               ...
		               <td style="color:#000000;font-size:80%;"> <?php echo $res->lecturas_subcategorias; ?>     </td>
					   <td style="color:#000000;font-size:80%;"> <?php echo $res->total_pdf_subcategorias; ?>     </td>
					   <td style="color:#000000;font-size:80%;"> <?php echo $res->total_xml_subcategorias; ?>     </td>
					   <td style="color:#000000;font-size:80%;"> <?php echo $res->subidos_xml_subcategorias; ?>     </td>
					   <td style="color:#000000;font-size:80%;"> <?php echo $res->total_xml_subcategorias; - $res->subidos_xml_subcategorias  ; ?>     </td>
