	    ...
	    <table>
		    <tr> 
		    	<td>
					...
					<input type="hidden" name="criterio_etapa" id="criterio_etapa_bus" class="form-control"   value="<?php echo $criterio_etapa; ?>" />
		    	</td>
		    </tr>
	    </table>
	   <div id="controlador">
